...
var creatorList = ['@nabilizard','@rezuoka'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'R e z u o k a') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'R e z u o k a') return res.json(loghandler.invalidKey)
